...
"""
stosic_v1_2csv.py — Fisher–Voronoi na Loto 7/39 (GHQ) — 7-node krug
...
GHQ = ROOT.parent
CSV_LOTO = GHQ / "data" / "loto7_4654_k58_loto_2949.csv"
CSV_PLUS = GHQ / "data" / "loto7_4654_k58_loto_plus_1705.csv"
CSV_PATH = CSV_LOTO
...
"""
next_loto:       [4, 9, 11, 14, 15, 19, 29]
next_loto_plus:  [1, 5, 6, 9, 21, 31, 39]
"""
